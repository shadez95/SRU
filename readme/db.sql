...
MySQL - 10.1.10-MariaDB : Database - arma3
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`arma3` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `objects` (
  ...
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8348 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `player_mission_connection` (
  ...
  KEY `id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3062 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `wi_reqobj` (
  ...
  `ro_type` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
